    ...
    "Groups": {
        "a": {
            "para_week": {
                "Days": [{
                        "Monday": {
                            "8:15 - 10:00": "AAAAAAAAAAAAAAAAAAA PARA",
            ...
            "Niepara_week": {
                "Days": [{
                        "Monday": {
                            "8:15 - 10:00": "AAAAAAAAAAAAAAAAAAA NIE PARA",
        ...
        "b": {
            "para_week": {
                "Days": [{
                        "Monday": {
                            "8:15 - 10:00": "BBBBBBBBBBBBBBBBBBB PARA",
                            "10:15 - 12:00": "BADANIA OPERACYJNE I TEORIA OPTYMALIZACJI (LB)",
                            "12:15 - 14:00": "BADANIA MARKETINGOWE W LOGISTYCE (ĆW)",
                            "14:15 - 16:00": "MODELOWANIE PROCESÓW I SYSTEMÓW LOGISTYCZNYCH (LB)",
                            "16:15 - 18:00": "BADANIA MARKETINGOWE W LOGISTYCE (ĆW)",
            ...
            "Niepara_week": {
                "Days": [{
                        "Monday": {
                            "8:15 - 10:00": "BBBBBBBBBBBBBBBBBBB NIE PARA",
                            "10:15 - 12:00": "SYSTEMY MAGAZYNOWE (W)",
                            "12:15 - 14:00": "SYSTEMY MAGAZYNOWE (W)",
                            "14:15 - 16:00": "SYSTEMY MAGAZYNOWE (W)",
                            "16:15 - 18:00": "SYSTEMY MAGAZYNOWE (W)",
...
function EvenFirstGroup() {
    function SetDAYS() {
        for (var i = 0; i < Day.length; i++) {
            Days.push(Arr.Groups.a.para_week.Days[i])
        };
...
// Не парная неделя для первой группы
function OddFirstGroup() {
    function SetDAYS() {
        for (var i = 0; i < Day.length; i++) {
            Days.push(Arr.Groups.a.Niepara_week.Days[i])
        };
...
// Парная неделя для второй группы
function EvenSecondGroup() {
    function SetDAYS() {
        for (var i = 0; i < Day.length; i++) {
            Days.push(Arr.Groups.b.para_week.Days[i])
        };
...
// Не парная неделя для второй группы
function OddSecondGroup() {
    function SetDAYS() {
        for (var i = 0; i < Day.length; i++) {
            Days.push(Arr.Groups.b.Niepara_week.Days[i])
        };
